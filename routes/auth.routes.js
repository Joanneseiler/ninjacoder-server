...
router.post('/signup', (req, res) => {
    ...
    async function handleParentSignUp() {
        ...
        if(!ensureParentFieldsAreSet(username, email, password, kidAge, secretWord)) {
            return;
        }
        ...
        try {
            let parent = await Parent.create({username, email, password: hash, kidAge, secretWord})
            //parent.password = "***";
    ...
    function ensureParentFieldsAreSet(username, email, password, kidAge, secretWord) {
